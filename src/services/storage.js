...
const DEFAULT_CAREER_PATHS = [
  // ═══ ROLE-BASED ═══
  {
    ...
    nodes: [
      ...
      { id: 'css',         label: 'CSS',                level: 0, type: 'skill', children: ['js-basics', 'git'] },
      { id: 'git',         label: 'Git',                level: 1, type: 'skill', children: ['github'] },
      { id: 'github',      label: 'GitHub',             level: 1, type: 'skill', children: ['cp-static'] },
      { id: 'js-basics',   label: 'JavaScript Basics',  level: 1, type: 'skill', children: ['cp-static'] },
      { id: 'cp-static',   label: 'Checkpoint — Website Tĩnh', level: 2, type: 'checkpoint', children: ['npm', 'typescript', 'dom'], tip: 'Tạm dừng lý thuyết! Hãy dùng HTML/CSS để xây dựng giao diện Portfolio.' },
      { id: 'npm',         label: 'Package Managers (npm)', level: 3, type: 'skill', children: ['tailwind'] },
      { id: 'typescript',  label: 'TypeScript',         level: 3, type: 'skill', children: ['api-fetching'] },
      { id: 'dom',         label: 'DOM Manipulation',   level: 3, type: 'skill', children: ['cp-interactivity'] },
      { id: 'tailwind',    label: 'Tailwind CSS',       level: 4, type: 'skill', children: ['react'] },
      { id: 'api-fetching',label: 'API Fetching (REST)',level: 4, type: 'skill', children: ['react'] },
      { id: 'cp-interactivity', label: 'Checkpoint — Web Động', level: 4, type: 'checkpoint', children: ['react'], tip: 'Sử dụng DOM và Fetch API để tạo ứng dụng Thời tiết cơ bản.' },
      { id: 'react',       label: 'React.js',           level: 5, type: 'skill', children: ['nextjs', 'state-mgmt'] },
      { id: 'nextjs',      label: 'Next.js (SSR/SSG)',  level: 6, type: 'skill', children: ['routing'] },
      { id: 'state-mgmt',  label: 'State Management',   level: 6, type: 'skill', children: ['routing'] },
      { id: 'routing',     label: 'React Router',       level: 7, type: 'skill', children: ['cp-frontend'] },
      { id: 'cp-frontend', label: 'Checkpoint — Ứng dụng React', level: 8, type: 'checkpoint', children: ['testing'], tip: 'Xây dựng ứng dụng E-Commerce với các state phức tạp.' },
      { id: 'testing',     label: 'Testing',            level: 9, type: 'skill', children: ['deploy'] },
      { id: 'deploy',      label: 'Build & Deploy',     level: 10, type: 'skill', children: [] }
    ]
  },
  {
    id: 'backend',
