...
const RESOURCES = {
  ...
  'cp-ds-python': [
    { title: 'Kaggle — Python', url: 'https://www.kaggle.com/learn/python', type: 'course' },
  ...
  'cp-ds-eda': [
    { title: 'Exploratory Data Analysis — IBM', url: 'https://www.ibm.com/topics/exploratory-data-analysis', type: 'article' },
  ],
  'cp-ds-features': [
    { title: 'ColumnTransformer — scikit-learn', url: 'https://scikit-learn.org/stable/modules/compose.html#columntransformer-for-heterogeneous-data', type: 'docs' },
  ],
  'cp-ds-model': [
    { title: 'Model Evaluation — scikit-learn', url: 'https://scikit-learn.org/stable/modules/model_evaluation.html', type: 'docs' },
  ],
  'cp-ds-deep-learning': [
